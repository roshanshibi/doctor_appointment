<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listofusers.aspx.cs" Inherits="Doctor_Appointment_System.listofusers" EnableEventValidation="false" %>
        ...
        <br />
            ...
            <br />
             ...
             <div class="card-body card-block">
                ...
                <asp:GridView ID="GridView1" runat="server" DataKeyNames="Id" CssClass="datatable table table-hover table-center mb-0" AutoGenerateColumns="False"  CellPadding="4" ForeColor="#333333" GridLines="None"  OnRowDeleting="GridView1_RowDeleting">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Password">
                                                <ItemTemplate >
                                                    <asp:Label ID="lblpassword" runat="server" Text='<%# Eval("Createpassword") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField >
                                                <ItemTemplate >
                                                  
                                                    <asp:ImageButton ID="imgDelete" runat="server" CommandName="Delete" ImageUrl="Admin/images/delete.png" Width="16px" Height="16px" OnClientClick="return confirm('Are you sure you want to delete this patient?');" />

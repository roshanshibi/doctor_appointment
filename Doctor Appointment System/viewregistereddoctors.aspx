<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewregistereddoctors.aspx.cs" Inherits="Doctor_Appointment_System.viewregistereddoctors" %>
                                                ...
                                                <div class="col col-md-12">
                                                    <div class="input-group">
                                                        <div class="input-group-btn">                                                           
                                                                ...
                                                                <asp:Button ID="btnsearch" class="fa fa-search" runat="server" Text="Search" CssClass="btn btn-primary"  OnClick="btnsearch_Click"  /></i>
                                                        </div>

                                                         <asp:TextBox ID="txtsearchdocdept" CssClass="form-control" placeholder="Search by name or department" runat="server"></asp:TextBox>
               ...
               <div style="width:100%;height:400px;overflow:scroll"><asp:GridView ID="GridView1" runat="server" DataKeyNames="Id" CssClass="datatable table table-hover table-center mb-0" AutoGenerateColumns="False"  CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDeleting="GridView1_RowDeleting" >
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Department">
                                             ...
                                             <asp:TemplateField HeaderText="Create password">
                                                <ItemTemplate >
                                                    <asp:Label ID="lblcreatepassword" runat="server" Text='<%# Eval("Createpassword") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

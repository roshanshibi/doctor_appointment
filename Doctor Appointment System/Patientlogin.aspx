<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Patientlogin.aspx.cs" Inherits="Doctor_Appointment_System.Patientlogin" %>
			...
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				...
				<form class="login100-form validate-form flex-sb flex-w" runat="server">
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Username is required">
						<input class="input100" type="text" name="username" runat="server" id="txtmail" required onblur="validateEmail(this);">
					...
					<div class="wrap-input100 validate-input m-b-12" data-validate = "Password is required">
						...
						<input class="input100" type="password" name="pass" runat="server" id="txtpass" autocomplete="off" required>
                    ...
                    <label><a href="patientsignup.aspx">Create an account</a></label>
                    <br />
                ...
                <label>Are you a doctor?<a href="doctorlogin.aspx">Login</a></label>
			</div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewfeeddoctor.aspx.cs" Inherits="Doctor_Appointment_System.viewfeeddoctor" %>
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="listofusers.aspx">List of logins</a>
                                </li>
                                <li>
        ...
        <div class="page-container">
            ...
            <br />
             ...
             <form runat="server">
               ...
               <div style="width:100%;height:400px;overflow:scroll"><asp:GridView ID="GridView1" runat="server" DataKeyNames="id" CssClass="datatable table table-hover table-center mb-0" AutoGenerateColumns="False" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowEditing="GridView1_RowEditing"  OnRowDeleting="GridView1_RowDeleting"   >
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Email">
                                                <ItemTemplate >
                                                    <asp:Label ID="lbldocemail" runat="server" Text='<%# Eval("Email") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Message">
                                                <ItemTemplate >
                                                    <asp:Label ID="lbldocmessage" runat="server" Text='<%# Eval("Message") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sendfeedback_doctor.aspx.cs" Inherits="Doctor_Appointment_System.sendfeedback_doctor" %>
        ...
        <div class="page-container">
            ...
            <div class="col-md-6 order-md-last d-flex">
              ...
              <div class="form-group">
                <textarea style="width:700px" id="txtmessage" runat="server" cols="30" rows="7" class="form-control" placeholder="Enter the message"></textarea>
               
              </div>
              <div class="form-group">
               <%-- <input type="submit" value="Send Message" class="btn btn-secondary py-3 px-5">--%>
               <asp:Button ID="btnsendmessage" runat="server" Text="Send" CssClass="btn btn-secondary py-3 px-5" />
              </div>

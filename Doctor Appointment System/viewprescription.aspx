<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewprescription.aspx.cs" Inherits="Doctor_Appointment_System.viewprescription" %>
             ...
             <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-12">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:Button ID="btnsearchdoctor" CssClass="btn btn-primary"  runat="server" Text="Search" />
                                                        </div>
                ...
                <asp:GridView ID="GridView1" runat="server" DataKeyNames="Id" CssClass="datatable table table-hover table-center mb-0" AutoGenerateColumns="False" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" > 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField >
                                                <ItemTemplate >
                                                   <asp:ImageButton ID="imgbook" runat="server" CommandName="Edit" ImageUrl="Admin/images/.png" Width="100px" Height="40px" />

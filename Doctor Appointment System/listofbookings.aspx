<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="listofbookings.aspx.cs" Inherits="Doctor_Appointment_System.listofbookings" %>
        ...
        <div class="page-container">
            ...
            <br />
             ...
             <div class="card-body card-block">
                                                ...
                                                <div class="col col-md-12">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:Button ID="btnsearch" CssClass="btn btn-primary"  runat="server" Text="Search" OnClick="btnsearch_Click"  />
                                                         ...
                                                         <asp:TextBox ID="txtsearchuser" runat="server" placeholder="Search by name" CssClass="form-control"></asp:TextBox>
                ...
                <asp:GridView ID="GridView1" runat="server" DataKeyNames="Id" CssClass="datatable table table-hover table-center mb-0" AutoGenerateColumns="False" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowEditing="GridView1_RowEditing" OnRowDeleting="GridView1_RowDeleting">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Patient number" >
                                                <ItemTemplate >
                                                    <asp:Label ID="lblpatnum" runat="server" Text='<%# Eval("PatNum") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Consulting date">
                                                <ItemTemplate >
                                                    <asp:Label ID="lbldate" runat="server" Text='<%# Eval("Date") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Consulting time">
                                                <ItemTemplate >
                                            ...
                                            <asp:TemplateField >
                                                <ItemTemplate >
                                                   <asp:ImageButton ID="imgEdit" runat="server" CommandName="Edit" ImageUrl="Admin/images/edit.png" Width="16px" Height="16px" />

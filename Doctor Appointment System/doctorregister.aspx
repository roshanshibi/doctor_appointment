<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="doctorregister.aspx.cs" Inherits="Doctor_Appointment_System.doctorregister" %>
                                        ...
                                        <hr>
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="txtemailid" runat="server" name="cc-name" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                                    autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error" onblur="validateEmail(this);">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="txtphone" runat="server" name="cc-number" type="tel" class="form-control cc-number identified visa" data-val="true"
                                                    data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number"
                                                    autocomplete="cc-number" value="" onkeypress="javascript:return isNumber(event)" maxlength="10" required>
                                             ...
                                             <div class="form-group has-success">
                                                ...
                                                <input id="txtage" runat="server" name="cc-name" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                                    autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error" value="" onkeypress="javascript:return isNumber(event)" required>
                                                <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                                 <script>
                                                     // WRITE THE VALIDATION SCRIPT.
                                                     function isNumber(evt) {
                                                    ...
                                                    <div class="form-check">
                                                        <div class="radio">
                                                            <label for="radio1" class="form-check-label ">
                                                                <input type="radio" runat="server" id="rbtnmale" name="radios" value="option1" class="form-check-input" required>Male
                                                            </label>
                                                        </div>
                                                        <div class="radio">
                                                            <label for="radio2" class="form-check-label ">
                                                                <input type="radio" runat="server" id="rbtnfemale" name="radios" value="option2" class="form-check-input" required>Female
                                                            </label>
                                                        </div>
                                            ...
                                            <div class="row form-group">
                                             ...
                                             <asp:DropDownList ID="txtdepartment" runat="server">
                                                 ...
                                                 <asp:ListItem> Psychatry</asp:ListItem>
                                           ...
                                           <div class="form-group has-success">
                                            ...
                                            <div class="row">
                                                ...
                                                <%--<button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                  ...
                                                  <asp:Button ID="btnsave" runat="server" Text="Submit" CssClass="btn btn-lg btn-info btn-block" OnClick="btnsave_Click"  />
                                                <div id="message">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="currentbookings.aspx.cs" Inherits="Doctor_Appointment_System.currentbookings" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
          ...
          <div class="card-body card-block">
           <asp:GridView ID="GridView1" runat="server" DataKeyNames="Id" CssClass="datatable table table-hover table-center mb-0" AutoGenerateColumns="False" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDeleting="GridView1_RowDeleting" >
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField >
                                                <ItemTemplate >
                                                    ...
                                                    <asp:ImageButton ID="imgDelete" runat="server" CommandName="Delete" ImageUrl="Admin/images/cancel.png" Width="110px" Height="50px" OnClientClick="return confirm('Are you sure you want to cancel this appointment?');" AlternateText="Delete"  />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deptadd.aspx.cs" Inherits="Doctor_Appointment_System.deptadd" %>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="txtdeptname" name="cc-payment" type="text" runat="server" class="form-control" >
                                            ...
                                            <div>
                                               ...
                                               <%-- </button>--%>
                                                 <asp:Button ID="btninserdept" runat="server" Text="Save" CssClass="btn btn-lg btn-info btn-block" OnClick="btninserdept_Click" />
                                            </div>
                                        </form>
                                    </div>
                                </div>

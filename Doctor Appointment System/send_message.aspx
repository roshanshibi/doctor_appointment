<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="send_message.aspx.cs" Inherits="Doctor_Appointment_System.send_message" %>
                ...
                <textarea style="width:700px" id="txtmessage" runat="server" cols="30" rows="7" class="form-control" placeholder="Enter the message"></textarea>
                    <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label">Send to :</label>
                                                </div>
